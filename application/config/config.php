...
//its will make both localhost and official dns available
if($_SERVER['HTTP_HOST'] == "mydopaminboost.local") {
    //localhost
    $config['base_url'] = 'http://mydopaminboost.local/';  
} else {
    //official website url
    $config['base_url'] = 'http://mydopaminboost.com.my/';
