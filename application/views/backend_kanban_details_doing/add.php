    ...
    <div class="content">
        ...
        <div class="container-fluid">
            ...
            <div class="row align-items-center">
                ...
                <div>
                    <br/>
                    <h3 class="page-title" ng-if="mode=='Add'"> Add Doing Task</h3>
                    <h3 class="page-title" ng-if="mode=='Edit'"> Edit Doing Task</h3>
                </div>
                                        ...
                                        <form class="form-horizontal angularFormValidationHelper" role="form"
                                            ...
                                            <fieldset>
                                                ...
                                                <div class="mb-2 row">
                                                    ...
                                                    <div class="mb-2 row">
                                                        <label for="doing_created_id" class="form-label">Created by</label>
                                                        <div>
                                                            <select class="form-select" ng-model="formDetail.created_by"
                                                                name="doing_created_id" id="doing_created_id"
                                                    ...
                                                    <div class="mb-2 row" ng-if="mode=='Edit'">  
                                                        <label for="doing_task_status" class="form-label">Task Status</label>  
                                                        <div class="">  
                                                            <select class="form-select" ng-model="formDetail.status" name="doing_task_status" id="doing_task_status" data-toggle="select2" required>  
                                                                <?php
                                                                if (!empty($statusList)) {
                                                    ...
                                                    <div class="mb-2 row">
                                                        <div class="col-md-4">
                                                            <label for="doing_task_title"
                                                                class="form-label">Task Title
                                                            </label>

                                                            <div class="">
                                                                <input type="text" name="doing_task_title" id="doing_task_title"
                                                    ...
                                                    <div class="mb-2 row">  
                                                        <label for="doing_task_type" class="form-label">Task Type</label>  
                                                        <div class="">  
                                                            <select class="form-select" ng-model="formDetail.type" name="doing_task_type" id="doing_task_type" data-toggle="select2" required>  
                                                                <?php
                                                                if (!empty($typeList)) {
                                                    ...
                                                    <div class="mb-2 row" ng-show="formDetail.type == 1">
                                                        <label for="doing_task_desc" class="form-label">Task Description</label>
                                                        <div class="textarea">
                                                            <textarea rows="5" name="doing_task_desc" id="doing_task_desc" placeholder="Please enter description of task" ng-model="doing_task_desc" class="form-control"></textarea>
                                                        </div>
                                                    </div>
                                                            ...
                                                            <div class="card-body">
                                                                ...
                                                                <div class="mt-2 mb-2">
                                                                    <table class="tablesaw table mb-0" wt-responsive-table>
                                                                        ...
                                                                        <tbody ng-if="doing_checkbox_details == '' || doing_checkbox_details == null">
                                                                        ...
                                                                        <!--if have data-->
                                                                        <tbody ng-if="doing_checkbox_details.length > 0">
                                                                            <tr ng-repeat="row in checkbox_details_row track by $index">
                                                                                <td class="align-middle">
                                                                                    {{$index + 1}}
                                                                                </td>
                                                    ...
                                                    <div class="mb-2 row">
                                                        ...
                                                        <datepicker date-format="yyyy-MM-dd" datepicker-mobile="true"
                                                            ...
                                                            <input type="text" name="doing_due_date"
                                                                ID="doing_due_date"
                                                                ng-model="doing_due_date"
                                                                class="form-control" data-date-time-picker required>
                                                        </datepicker>
                                                    </div>

                                                    <div class="mb-2 row">
                                                        <label for="doing_due_time" class="form-label">Task Due Time</label>
                                                        <span><small style="color: red;">*Click clock icon to select due time</small></span>
                                                        <input type="time" name="doing_due_time" id="doing_due_time" ng-model="doing_due_time" class="form-control" required>
                                                    </div>
        ...
        <script>
            ...
            app.controller("myCtrl", function($scope, $http, $timeout) {
                ...
                $scope.$watchGroup(["doing_due_date", "doing_due_time"], function(newValues) {
                ...
                if ($scope.id != "") {
                    ...
                    $http.get("<?= base_url('api/detailsKanbanDetailsDoing') ?>/" + $scope.id).then(function(response) {

                        if (response.data.status == "OK") {
                            $scope.errorAlert = false;
                            console.log("response", response);
                            $scope.formDetail = response.data.result.kanban_doing;

                            // if type is Plain Text
                            if ($scope.formDetail.type == 1) {

                                $scope.doing_task_desc = $scope.formDetail.content_description
                            ...
                            $scope.doing_due_date = parts[0]; // "2025-01-25"
                            ...
                            $scope.doing_due_time = dateObject; // Assign as Date object
                ...
                $scope.saveData = function() {
                    ...
                    if ($scope.formDetail.type == 1) {
                        if (!$scope.doing_task_desc || $scope.doing_task_desc == "") {
                            alert("Task Description Cannot Empty.");
                            return;
                        }
                        tobeSubmit["content_description"] = $scope.doing_task_desc;
                    ...
                    loadingshow();
                    $http.post("<?= base_url('api/submitKanbanDetailsDoing') ?>", tobeSubmit).then(function(response) {
                        loadinghide();
                        if (response.data.status == "OK") {
