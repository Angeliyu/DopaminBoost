    ...
    <div class="content">
        ...
        <div class="container-fluid">
            ...
            <div class="row align-items-center">
                ...
                <div>
                    <br/>
                    <h3 class="page-title" ng-if="mode=='Add'"> Add Todo Task</h3>
                    <h3 class="page-title" ng-if="mode=='Edit'"> Edit Todo Task</h3>
                </div>
                                        ...
                                        <form class="form-horizontal angularFormValidationHelper" role="form"
                                            ...
                                            <fieldset>
                                                ...
                                                <div class="mb-2 row">
                                                    ...
                                                    <div class="mb-2 row">
                                                        <label for="todo_created_id" class="form-label">Created by</label>
                                                        <div>
                                                    ...
                                                    <div class="mb-2 row" ng-if="mode=='Edit'">  
                                                        <label for="todo_task_status" class="form-label">Task Status</label>  
                                                        <div class="">  
                                                            <select class="form-select" ng-model="formDetail.status" name="todo_task_status" id="todo_task_status" data-toggle="select2" required>  
                                                                <?php
                                                                if (!empty($statusList)) {
                                                    ...
                                                    <div class="mb-2 row">  
                                                        ...
                                                        <div class="">  
                                                            <select class="form-select" ng-model="formDetail.type" name="todo_task_type" id="todo_task_type" data-toggle="select2" required>  
                                                                <?php
                                                                if (!empty($typeList)) {
                                                    ...
                                                    <div class="mb-2 row" ng-show="formDetail.type == 1">
                                                        ...
                                                        <div class="textarea">
                                                            <textarea rows="5" name="todo_task_desc" id="todo_task_desc" placeholder="Please enter description of task" ng-model="todo_task_desc" class="form-control"></textarea>
                                                        </div>
                                                    </div>
                                                                    ...
                                                                    <table class="tablesaw table mb-0" wt-responsive-table>
                                                                        <thead>
                                                                            <tr>
                                                                                ...
                                                                                <th class="align-middle" style="text-align: center;" scope="col">
                                                                                    Checked
                                                                                </th>
                                                                            </tr>
                                                                        </thead>
                                                                        <tbody>
                                                                            <tr ng-repeat="row in checkbox_details_row track by $index">
                                                                                ...
                                                                                <td class="align-middle" style="text-align: center;">  
                                                                                    <input type="checkbox" ng-model="row.checked" ng-true-value="'true'" ng-false-value="'false'" style="transform: scale(1.5); margin: 0;"/>  
                                                                                </td>  
                                                    ...
                                                    <div class="mb-2 row">
                                                        ...
                                                        <span><small style="color: red;">*Due date only able to select start tomorrow</small></span>
                                                        <datepicker date-format="yyyy-MM-dd" datepicker-mobile="true"
                                                            selector="form-control" date-min-limit="{{ minDate }}">
                                                            <input type="text" name="todo_due_date"
                                                                ID="todo_due_date"
                                                                ng-model="todo_due_date"
                                                                class="form-control" data-date-time-picker required>
                                                        </datepicker>
                                                    </div>

                                                    <div class="mb-2 row">
                                                        <label for="todo_due_time" class="form-label">Task Due Time</label>
                                                        <span><small style="color: red;">*Click clock icon to select due time</small></span>
                                                        <input type="time" name="todo_due_time" id="todo_due_time" ng-model="todo_due_time" class="form-control" required>
                                                    </div>
        ...
        <script>
            ...
            app.controller("myCtrl", function($scope, $http, $timeout) {
                ...
                $scope.add_checkbox_details_table = function() {
                    ...
                    if ($scope.adddetect.add_checkbox_details) {
                        ...
                        $scope.checkbox_details_row.push({
                            ...
                            checked: false  // Initialize the checkbox state as unchecked 
                        });
                ...
                $scope.$watchGroup(["todo_due_date", "todo_due_time"], function(newValues) {
                ...
                if ($scope.id != "") {
                    ...
                    $http.get("<?= base_url('api/detailsKanbanDetailTodo') ?>/" + $scope.id).then(function(response) {

                        if (response.data.status == "OK") {
                            $scope.errorAlert = false;
                            console.log("response", response);
                            $scope.formDetail = response.data.result.kanban_todo;

                            // if type is Plain Text
                            if ($scope.formDetail.type == 1) {

                                $scope.todo_task_desc = $scope.formDetail.content_description
                            ...
                            $scope.todo_due_date = parts[0]; // "2025-01-25"
                            ...
                            $scope.todo_due_time = dateObject; // Assign as Date object
                ...
                $scope.saveData = function() {
                    ...
                    loadingshow();
                    $http.post("<?= base_url('api/submitKanbanDetailsTodo') ?>", tobeSubmit).then(function(response) {
                        loadinghide();
                        if (response.data.status == "OK") {
