							...
							<div class="row">
                                <div class="col-xs-12" style="text-align: right;">
                                    ...
                                    <div>
										...
										<a href="<?= base_url('admin_add_kanban_details_todo') ?>" class="btn btn-info btn-sm" style="color: white;">Create Kanban Details Todo</a>
        ...
        <script>
            ...
            app.controller("myCtrl", function($scope, $http, $timeout) {
				...
				$scope.chosenData = function(data) {
					...
					location.href = "<?= base_url('admin_edit_kanban_details_todo') ?>/" + data;
				}
